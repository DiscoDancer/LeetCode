public class Solution {
    ...
    // потому что идем сверху вниз
    // 1022 = все единички, я просто начал с 2, поэтому первый бит всегда 0
    private bool IsFilled() {
        return _columns.Last() == 1022 && _rows.Last() == 1022 && _squares.Last() == 1022;
    }
