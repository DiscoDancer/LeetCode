    ...
    public double findMedianSortedArrays(int[] nums1, int[] nums2) {
        ...
        if ((nums1.length + nums2.length) % 2 == 1) {
            for (var i1 = 0; i1 < nums1.length; i1++) {
                ...
                var leftCount1 = i1;
                // not including current
                var rightCount1 = nums1.length - i1 - 1;
                ...
                for (var j = i1 + 1; j < nums1.length; j++) {
                    if (nums1[j] == nums1[i1]) {
                        equalCount1++;
                        rightCount1--;
                    } else {
                ...
                var l = lessThanCount2 + leftCount1;
                var r = l + equalCount1 + equalCount2;
