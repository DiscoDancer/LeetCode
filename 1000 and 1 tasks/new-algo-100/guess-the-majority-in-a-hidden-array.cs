...
/*
    Идея в том, что сравнения (x, A, B, C) и (y, A, B, C) могут сказать равны ли х и y
    Я разбил на 4 группы ниже, а потом объединил, но вероятно, этого не требовалось, можно просто было все сравнить и готово
