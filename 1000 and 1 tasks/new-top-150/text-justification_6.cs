public class Solution {
    ...
    private int _curLineBufferWordLengthsSum = 0;
    ...
    private bool CanWordFitInCurrentLine(string word)
    {
        ...
        // add words
        minCharactersRequiredToAddWtoCurrentLine += _curLineBufferWordLengthsSum;
        // add spaces
    ...
    {
        var allSpacesInLineLength = _maxWidth - _curLineBufferWordLengthsSum;
    ...
    private void FullJustifyInner(string[] words)
    {
        foreach (var w in words)
        {
            if (CanWordFitInCurrentLine(w)) {
                ...
                _curLineBufferWordLengthsSum += w.Length;
            }
            else {
